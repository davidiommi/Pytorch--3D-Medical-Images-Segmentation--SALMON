...
from monai.transforms import (Compose,  RepeatChanneld, LoadImaged, AddChanneld, Transpose,Activations,AsDiscrete, RandGaussianSmoothd, CropForegroundd, SpatialPadd,
...
def join_channels(result_array, channels):
    result_array = result_array.squeeze().data.cpu().numpy()
...
def main():
    ...
    post_trans = AsDiscrete(argmax=True, to_onehot=True, n_classes=opt.out_channels)
