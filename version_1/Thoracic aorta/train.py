...
from monai.transforms import (Compose, LoadNiftid, AddChanneld, Transpose,
    ...
    Spacingd, Orientationd, CropForegroundd, ScaleIntensityRanged, RandShiftIntensityd, BorderPadd, RandGaussianNoised, RandAdjustContrastd,NormalizeIntensityd,RandFlipd)
