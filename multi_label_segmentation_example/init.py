...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--increase_factor_data',  default=3, help='Increase data number per epoch')
        parser.add_argument('--preload', type=str, default=None)
        parser.add_argument('--gpu_ids', type=str, default='0,1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--workers', default=8, type=int, help='number of data loading workers')

        # dataset parameters
        parser.add_argument('--patch_size', default=(256, 256, 32), help='Size of the patches extracted from the image')
        parser.add_argument('--spacing', default=image_spacing, help='Original Resolution')
        parser.add_argument('--resolution', default=(0.6, 0.6, 3), help='New Resolution, if you want to resample the data')
        parser.add_argument('--batch_size', type=int, default=4, help='batch size')
        parser.add_argument('--in_channels', default=1, type=int, help='Channels of the input')
        parser.add_argument('--out_channels', default=3, type=int, help='Channels of the output')
