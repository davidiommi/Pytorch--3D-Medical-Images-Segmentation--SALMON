...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--spacing', default=[3, 3, 3], help='Original Resolution')
        parser.add_argument('--resolution', default=[3, 3, 3], help='New Resolution, if you want to resample the data')
